...
public class MainActivity extends AppCompatActivity {
    ...
    public void createTeam() {
        ...
        listTeams.add(obj);
        obj = new SoccerTeam("Paraná Clube", "Curitiba", "Paraná", "O Paraná Clube nasceu da fusão do Colorado Esporte Clube e do Esporte Clube Pinheiros em 1989 e o resultado dela foi o sucesso do clube que nos primeiros dez anos de vida, pois venceu seis vezes o Campeonato Paranaense de Futebol.", R.drawable.parana);
        listTeams.add(obj);
